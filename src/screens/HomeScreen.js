      ...
      <div className="parent-container">
        ...
        >
          <Container>
            ...
            >
              <Card.Body>
                <Card.Title style={{ color: "grey", fontSize: "55px" }}>
                  Welcome to Our Art Community
                </Card.Title>
                <Card.Text style={{ color: "white", fontSize: "20px" }}>
                  Our goal is to cherish and celebrate the artist and share the
                  stories behind and connect them with people. You need to have
                  a invite code to join us.
                </Card.Text>
                <Form>
                  <Form.Group
